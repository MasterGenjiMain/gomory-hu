...
public class WebController {
    ...
    public String mainPage() {
        gomoryHuAlgorithm.showResultByClassicMethod(setupTestEdges());
        return "Classic algorithm looks fine";
    }

    @GetMapping("/classic-OTN")
    public String classicOTN() {
        gomoryHuAlgorithm.showResultWithAdaptingToOTN(setupTestEdges());
        return "Adapted algorithm looks fine";
    }
